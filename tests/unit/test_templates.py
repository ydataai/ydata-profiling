from pandas_profiling.report.presentation.flavours.html import HTMLHTML
from pandas_profiling.report.presentation.flavours.html.templates import template
