...
from data_profiling.model.summarizer import ProfilingSummarizer, format_summary
        ...
        pps.summarize(
            ...
            pd.Series(
                [
                    os.path.abspath(
                        base_path
                        + r"../../../src/data_profiling/model/typeset_does_not_exist.py"
                    )
                ]
            ),
            "Path",
    ...
    _ = format_summary(
        pps.summarize(
            ...
            pd.Series(
                [
                    os.path.abspath(
                        base_path + r"../../../src/data_profiling/model/typeset.py"
                    )
                ]
            ),
            "File",
