...
def test_issue437():
    try:
        ...
        assert description_set["variables"]["a"]["type"].__name__ == "Numeric"
        assert description_set["variables"]["b"]["type"].__name__ == "Numeric"
        assert description_set["variables"]["c"]["type"].__name__ == "Numeric"
