    ...
    "Pandas Profiling Benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "2e635fa8a227e85c29ded6cb5e461d273076334b",
          "message": "ci: pre-commit updates",
          "timestamp": "2021-11-21T10:42:49Z",
          "tree_id": "a8dd009b03cc88aaf0d97c6ce67a537a93428f59",
          "url": "https://github.com/pandas-profiling/pandas-profiling/commit/2e635fa8a227e85c29ded6cb5e461d273076334b"
        },
        "date": 1637492490398,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/benchmarks/bench.py::test_titanic_explorative",
            "value": 0.08526715120615816,
            "unit": "iter/sec",
            "range": "stddev: 0.21243638065014187",
            "extra": "mean: 11.727845786499994 sec\nrounds: 10"
          },
          {
            "name": "tests/benchmarks/bench.py::test_titanic_default",
            "value": 0.0852876568217674,
            "unit": "iter/sec",
            "range": "stddev: 0.18139886585325887",
            "extra": "mean: 11.725026073699997 sec\nrounds: 10"
          },
          {
            "name": "tests/benchmarks/bench.py::test_titanic_minimal",
            "value": 0.35689039108300785,
            "unit": "iter/sec",
            "range": "stddev: 0.0825952198927112",
            "extra": "mean: 2.801980734099993 sec\nrounds: 10"
          },
          {
            "name": "tests/benchmarks/bench.py::test_rdw_minimal",
            "value": 0.05642814436253552,
            "unit": "iter/sec",
            "range": "stddev: 0.27940295550047156",
            "extra": "mean: 17.721653109400005 sec\nrounds: 10"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1e08d0440ae4570cd2395e142382b63ef7f7b77f",
          "message": "ci: update dependencies",
          "timestamp": "2021-11-22T17:52:45Z",
          "tree_id": "0ef6aa0c4fa719829e4f684d730903baaa8a7e3c",
          "url": "https://github.com/pandas-profiling/pandas-profiling/commit/1e08d0440ae4570cd2395e142382b63ef7f7b77f"
        },
        "date": 1637604726868,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/benchmarks/bench.py::test_titanic_explorative",
            "value": 0.08236173784833412,
            "unit": "iter/sec",
            "range": "stddev: 0.19652285151108564",
            "extra": "mean: 12.141560221100002 sec\nrounds: 10"
          },
          {
            "name": "tests/benchmarks/bench.py::test_titanic_default",
            "value": 0.08245872062838919,
            "unit": "iter/sec",
            "range": "stddev: 0.2512581833634402",
            "extra": "mean: 12.127280078800016 sec\nrounds: 10"
          },
          {
            "name": "tests/benchmarks/bench.py::test_titanic_minimal",
            "value": 0.3486817797080365,
            "unit": "iter/sec",
            "range": "stddev: 0.09061461937166754",
            "extra": "mean: 2.8679445218999833 sec\nrounds: 10"
          },
          {
            "name": "tests/benchmarks/bench.py::test_rdw_minimal",
            "value": 0.055062928732029476,
            "unit": "iter/sec",
            "range": "stddev: 0.22355563886437368",
            "extra": "mean: 18.161039069799994 sec\nrounds: 10"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d77ddbe7ee640d388bef45b789a34f97d0b129c1",
          "message": "ci: pre-commit updates",
          "timestamp": "2021-11-25T17:52:32Z",
          "tree_id": "2330a75cec92fca46f6e644ca13d91dd8252e7de",
          "url": "https://github.com/pandas-profiling/pandas-profiling/commit/d77ddbe7ee640d388bef45b789a34f97d0b129c1"
        },
        "date": 1637863551919,
        "tool": "pytest",
        "benches": [
          {
            "name": "tests/benchmarks/bench.py::test_titanic_explorative",
            "value": 0.1193324275405184,
            "unit": "iter/sec",
            "range": "stddev: 0.11255536651886396",
            "extra": "mean: 8.379951875699987 sec\nrounds: 10"
          },
          {
            "name": "tests/benchmarks/bench.py::test_titanic_default",
            "value": 0.11922561342279722,
            "unit": "iter/sec",
            "range": "stddev: 0.09461116322505261",
            "extra": "mean: 8.387459466899998 sec\nrounds: 10"
          },
          {
            "name": "tests/benchmarks/bench.py::test_titanic_minimal",
            "value": 0.5769732633890021,
            "unit": "iter/sec",
            "range": "stddev: 0.0905521644905562",
            "extra": "mean: 1.7331825640000034 sec\nrounds: 10"
          },
          {
            "name": "tests/benchmarks/bench.py::test_rdw_minimal",
            "value": 0.0815708292166374,
            "unit": "iter/sec",
            "range": "stddev: 0.1570250485319523",
            "extra": "mean: 12.259284472199989 sec\nrounds: 10"
          }
        ]
      }
    ]
