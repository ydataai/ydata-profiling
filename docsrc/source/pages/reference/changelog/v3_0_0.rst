...
- Automated configuration documentation `API <https://pandas-profiling.github.io/pandas-profiling/docs/master/rtd/pages/api/_autosummary/ydata_profiling.config.Settings.html>`_.
