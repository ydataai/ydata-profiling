...
- Various issues could not be (easily) solved in the previous configuration architecture, are fixed in this release (`[584] <https://github.com/ydataai/ydata-profiling/issues/584>`_, `[644] <https://github.com/ydataai/ydata-profiling/issues/644>`_, `[698] <https://github.com/ydataai/ydata-profiling/issues/698>`_, `[720] <https://github.com/ydataai/ydata-profiling/issues/720>`_ and `[724] <https://github.com/ydataai/ydata-profiling/issues/724>`_)
- Fix crash with exotic characters (`[707] <https://github.com/ydataai/ydata-profiling/issues/707>`_)
...
- Automated configuration documentation `API <https://ydata-profiling.github.io/ydata-profiling/docs/master/rtd/pages/api/_autosummary/ydata_profiling.config.Settings.html>`_.
