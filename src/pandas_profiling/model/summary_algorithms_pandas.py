...
def describe_counts_pandas(series: pd.Series, summary: dict) -> Tuple[pd.Series, dict]:
...
def describe_generic_pandas(series: pd.Series, summary: dict) -> Tuple[pd.Series, dict]:
...
def describe_numeric_1d_pandas(
    series: pd.Series, summary: dict
) -> Tuple[pd.Series, dict]:
...
@series_hashable
@func_nullable_series_contains
def describe_date_1d_pandas(series: pd.Series, summary: dict) -> Tuple[pd.Series, dict]:
...
@series_hashable
@func_nullable_series_contains
def describe_categorical_1d_pandas(
    series: pd.Series, summary: dict
) -> Tuple[pd.Series, dict]:
...
def describe_url_1d_pandas(series: pd.Series, summary: dict) -> Tuple[pd.Series, dict]:
...
def describe_file_1d_pandas(series: pd.Series, summary: dict) -> Tuple[pd.Series, dict]:
    assert not series.hasnans
    assert hasattr(series, "str")
...
def describe_path_1d_pandas(series: pd.Series, summary: dict) -> Tuple[pd.Series, dict]:
...
@series_hashable
def describe_boolean_1d_pandas(
    series: pd.Series, summary: dict
) -> Tuple[pd.Series, dict]:
