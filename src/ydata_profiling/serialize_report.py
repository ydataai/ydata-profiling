        ...
        if (df_hash == self.df_hash) or (self.df is None):
            ...
            if (
                ...
                warnings.warn(
                    ...
                    f"Currently running on pandas-profiling {__version__} , while loaded data is generated by ydata_profiling, {loaded_description_set['package']['ydata_profiling_version']}."
                )
